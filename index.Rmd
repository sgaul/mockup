...
grid.arrange(poorrate, sumpoor, nrow = 1, ncol = 2)
```
...
ggplot(data = income.tract) + 
  geom_dotplot(aes(x = income, fill = Towngroup, colour = Towngroup), 
               stackgroups = TRUE, binpositions = "all", binwidth = 4000) +
  scale_x_continuous(labels = comma) + 
...
#Make the map
vote2 <- ggplot(data = choropleth, aes(long, lat, group = group)) +
